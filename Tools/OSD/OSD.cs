...
namespace OSD
{
    public partial class OSD : Form
    {
        ...
        void setupFunctions()
        {
            ...
            // 最初の8個の表示項目
            // 表示名、描画関数、X座標、Y座標、有効アドレス、Xアドレス、Yアドレス
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("中央マーカー", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ピッチ", pan.panPitch, 22, 10, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ロール", pan.panRoll, 11, 1, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("バッテリー", pan.panBatt_A, 1, 13, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR);
            // panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("バッテリーB", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("補足衛星数", pan.panGPSats, 1, 9, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPSロック", pan.panGPL, 1, 10, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS座標", pan.panGPS, 1, 14, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR);

            // 次の8個の表示項目
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("方位リング", pan.panRose, 17, 14, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("方位", pan.panHeading, 24, 13, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ハートビート", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("帰還先方向", pan.panHomeDir, 14, 3, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ホーム距離", pan.panHomeDis, 22, 1, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("WP方向", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("WP距離", pan.panWPDis, 20, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR);

            // rssi（電波強度）に関する項目は未追加

            // 第3グループ（9項目）
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("高度", pan.panAlt, 22, 3, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ホーム高度", pan.panHomeAlt, 22, 2, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("上昇率", pan.panClimb, 1, 7, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("バッテリー残量", pan.panBatteryPercent, 1, 5, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("電流", pan.panCur_A, 1, 12, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("速度", pan.panVel, 1, 2, panVel_en_ADDR, panVel_x_ADDR, panVel_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("対気速度", pan.panAirSpeed, 1, 1, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("スロットル", pan.panThr, 1, 4, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("フライトモード", pan.panFlightMode, 18, 13, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR);

            // 第4グループ（9項目）
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("人工水平器", pan.panHorizon, 8, 6, panHorizon_en_ADDR, panHorizon_x_ADDR, panHorizon_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("風速", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("警告", pan.panWarn, 9, 4, panWarn_en_ADDR, panWarn_x_ADDR, panWarn_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("時間", pan.panTime, 22, 4, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("RSSI（電波強度）", pan.panRSSI, 12, 12, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("チューン（音）", pan.panTune, 1, 1, panTune_en_ADDR, panTune_x_ADDR, panTune_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("効率", pan.panEff, 1, 3, panEff_en_ADDR, panEff_x_ADDR, panEff_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("コールサイン", pan.panCALLSIGN, 1, 0, panCALLSIGN_en_ADDR, panCALLSIGN_x_ADDR, panCALLSIGN_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("チャンネル（Raw）", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR);
            ...
            // 最初の8個の表示項目
            // 表示名、描画関数、X座標、Y座標、有効アドレス、Xアドレス、Yアドレス
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("中央マーカー", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ピッチ", pan.panPitch, 22, 10, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ロール", pan.panRoll, 11, 1, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("バッテリー", pan.panBatt_A, 1, 13, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR);
            // panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("バッテリーB", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("補足衛星数", pan.panGPSats, 1, 9, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPSロック", pan.panGPL, 1, 10, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS座標", pan.panGPS, 1, 14, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR);

            // 次の8個の表示項目
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("方位リング", pan.panRose, 17, 14, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("方位", pan.panHeading, 24, 13, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ハートビート", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("帰還先方向", pan.panHomeDir, 14, 3, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ホーム距離", pan.panHomeDis, 22, 1, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("WP方向", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("WP距離", pan.panWPDis, 20, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR);

            // rssi（電波強度）表示などは未追加

            // 第3グループ（8項目）
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("高度", pan.panAlt, 22, 3, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("ホーム高度", pan.panHomeAlt, 22, 2, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("上昇率", pan.panClimb, 1, 7, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("バッテリー残量", pan.panBatteryPercent, 1, 5, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("電流", pan.panCur_A, 1, 12, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("速度", pan.panVel, 1, 2, panVel_en_ADDR, panVel_x_ADDR, panVel_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("対気速度", pan.panAirSpeed, 1, 1, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("スロットル", pan.panThr, 1, 4, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR);

            // 第4グループ（9項目）
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("フライトモード", pan.panFlightMode, 18, 13, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("人工水平器", pan.panHorizon, 8, 6, panHorizon_en_ADDR, panHorizon_x_ADDR, panHorizon_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("風速", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("警告", pan.panWarn, 9, 4, panWarn_en_ADDR, panWarn_x_ADDR, panWarn_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("時間", pan.panTime, 22, 4, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("RSSI（電波強度）", pan.panRSSI, 12, 12, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("チューン（音）", pan.panTune, 1, 1, panTune_en_ADDR, panTune_x_ADDR, panTune_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("効率", pan.panEff, 1, 3, panEff_en_ADDR, panEff_x_ADDR, panEff_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("コールサイン", pan.panCALLSIGN, 1, 0, panCALLSIGN_en_ADDR, panCALLSIGN_x_ADDR, panCALLSIGN_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("チャンネル（Raw）", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR);
            ...
            if (pan.converts == 0)
            {
                UNITS_combo.SelectedIndex = 0; // メートル法（Metric）
                STALL_label.Text = "失速速度 (km/h)";
                OVERSPEED_label.Text = "超過速度 (km/h)";
            }
            else if (pan.converts == 1)
            {
                UNITS_combo.SelectedIndex = 1; // ヤード・ポンド法（Imperial）
                STALL_label.Text = "失速速度 (mph)";
                OVERSPEED_label.Text = "超過速度 (mph)";
            }
        ...
        private void BUT_ReadOSD_Click(object sender, EventArgs e)
        {
            ...
            // 設定パネルの初期化
            pan.converts = eeprom[measure_ADDR];  // EEPROMから単位設定を読み込み
            ...
            {
                UNITS_combo.SelectedIndex = 1; // インペリアル（imperial）
                STALL_label.Text = "失速速度 (mph)";
                OVERSPEED_label.Text = "超過速度 (mph)";
            }
            else // EEPROMに無効な値が入っている場合はデフォルト（メートル法）に設定
            {
                pan.converts = 0; // 正常な値に修正
                UNITS_combo.SelectedIndex = 0; // メートル法（metric）
                STALL_label.Text = "失速速度 (km/h)";
                OVERSPEED_label.Text = "超過速度 (km/h)";
            }
            ...
            if (ofd.FileName != "")
            {
                try
                {
                    using (StreamReader sr = new StreamReader(ofd.OpenFile()))
                    {
                        ...
                        // 単位を変更（ユーザー設定またはEEPROMからの読み出しに基づく）
                        if (pan.converts == 0)
                        {
                            UNITS_combo.SelectedIndex = 0; // メートル法を選択
                            STALL_label.Text = "失速速度 (km/h)";
                            OVERSPEED_label.Text = "超過速度 (km/h)";
                        }
                        else if (pan.converts == 1)
                        {
                            UNITS_combo.SelectedIndex = 1; // ヤード・ポンド法（インペリアル）を選択
                            STALL_label.Text = "失速速度 (mph)";
                            OVERSPEED_label.Text = "超過速度 (mph)";
                        }
                        else // EEPROMに壊れたデータ（異常値）が入っている場合は、デフォルト（メートル法）に戻す
                        {
                            pan.converts = 0; // 正常なデフォルト値に修正
                            UNITS_combo.SelectedIndex = 0; // メートル法を選択
                            STALL_label.Text = "失速速度 (km/h)";
                            OVERSPEED_label.Text = "超過速度 (km/h)";
                        }
        ...
        private void UNITS_combo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                pan.converts = 0; // メートル法（Metric）を選択
                STALL_label.Text = "失速速度 (km/h)";
                OVERSPEED_label.Text = "超過速度 (km/h)";
            }
            else if (UNITS_combo.SelectedIndex == 1)
            {
                pan.converts = 1; // インペリアル（ヤード・ポンド法）を選択
                STALL_label.Text = "失速速度 (mph)";
                OVERSPEED_label.Text = "超過速度 (mph)";
            }
        }
        ...
        private void gettingStartedToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("ウェブページを開くことができませんでした。ウイルス対策ソフトや接続環境をご確認ください。"); }
        }
        ...
        private void website1(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://nozawa-system.com/");
            }
            catch { MessageBox.Show("ウェブページを開くことができませんでした。ウイルス対策ソフトや接続環境をご確認ください。"); }
        }

        private void website2(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://nozawa-system.com/item/sub/OSD.html");
            }
            catch { MessageBox.Show("ウェブページを開くことができませんでした。ウイルス対策ソフトや接続環境をご確認ください。"); }
        }
